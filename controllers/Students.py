...
def save(names,phone,regno,hasInsurance,insuranceType,insuranceNumber):
    cur = db.connection.cursor()
    cur.execute("INSERT INTO students SET names=%s,phone=%s,regno=%s,has_insurance=%s,insurance_type=%s,insurance_number=%s",(names,phone,regno,hasInsurance,insuranceType,insuranceNumber))
